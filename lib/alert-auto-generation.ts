...
async function buildAiCandidates(activity: AppActivity[]): Promise<AlertCandidate[]> {
  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: `You are SecondMind's alert monitor. Analyze only this real connected app activity and return important alerts that deserve the user's attention.
