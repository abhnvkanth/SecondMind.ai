...
function AiAgentPanel({ user }: { user: any }) {
  ...
  useEffect(() => {
    const stored = localStorage.getItem("secondmind_chat_history");
    if (stored) {
      try {
        ...
        if (Date.now() - parsed.updatedAt < oneDayMs) {
          ...
          localStorage.removeItem("secondmind_chat_history");
        }
      } catch (e) {
      ...
      setMessages([
        {
          sender: "agent",
          text: "Hello! I am your SecondMind cognitive personal assistant. I monitor your connected Gmail, WhatsApp, and Telegram in real-time. Ask me to draft email replies, fetch summaries, or list your action items."
        }
      ]);
    }
  }, []);
      ...
      <div className="h-[85vh] flex flex-col bg-white dark:bg-[#090d1a] border border-black/[0.05] dark:border-white/5 rounded-3xl overflow-hidden shadow-xl">
        ...
        <div className="px-6 py-4 bg-slate-50/50 dark:bg-white/[0.01] border-b border-black/[0.05] dark:border-white/5 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-sm font-bold text-slate-800 dark:text-white leading-tight">SecondMind Intelligent Agent</h3>
    ...
    <div className="space-y-8 animate-fade-in relative pb-12">
      <div>
        ...
        <p className="text-xs md:text-sm text-slate-400 light:text-slate-600 mt-1">
          Bridge your communication channels to SecondMind&apos;s background processing model using local and secure MCP configurations.
        </p>
      </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#030712] light:bg-slate-50">
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-slate-500 light:text-slate-600">
                  The following Model Context Protocol (MCP) tools are exposed by this platform to your SecondMind cognitive personal assistant.
                </p>
              </div>
...
const SETTINGS_STORAGE_KEY = "secondmind_assistant_settings";
      ...
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
            Tune how SecondMind summarizes, alerts, syncs data, and protects your workspace.
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <button
