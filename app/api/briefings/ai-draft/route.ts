...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = isEmail
      ? `You are SecondMind, an AI personal assistant. Draft a professional, concise email reply.
...
- Output only the email body text, no markdown formatting`
      : `You are SecondMind, an AI personal assistant. Draft a concise, natural message reply.
