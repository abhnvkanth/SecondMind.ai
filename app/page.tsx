    ...
    <div className="min-h-screen text-slate-200 bg-[#030712] relative overflow-hidden font-sans">
      ...
      <section className="pt-32 pb-24 md:pt-44 md:pb-32 relative z-10 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="inline-flex items-center space-x-2.5 px-4 py-1.5 rounded-full glass border border-purple-500/20 mb-8 animate-float">
          ...
          <span className="text-xs font-semibold text-purple-300 tracking-wide">Introducing SecondMind 1.0</span>
          ...
          <div className="absolute top-0 left-0 right-0 h-10 bg-slate-900/80 border-b border-white/5 flex items-center px-4 space-x-2">
            ...
            <div className="flex-1 flex justify-center">
              <div className="w-64 h-5 rounded bg-white/5 border border-white/5 flex items-center justify-center">
                <span className="text-[10px] text-slate-500">secondmind.ai/dashboard/overview</span>
              </div>
            </div>
          </div>
      ...
      <section id="features" className="py-24 relative z-10 px-6 max-w-7xl mx-auto border-t border-white/5">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-400 text-base sm:text-lg">
            Say goodbye to jumping between messaging apps, emails, and calendar schedules. SecondMind handles it all automatically.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="glass-premium rounded-2xl p-8 flex flex-col justify-between hover:border-white/10 transition duration-300">
            <div className="space-y-4">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Never drop a promise again. SecondMind automatically detects casual commitments like "I'll call you at 4 PM" or "Sending document tonight", sending push reminders to keep you on schedule.
              </p>
            </div>
          ...
          <div className="md:col-span-2 glass-premium rounded-2xl p-8 flex flex-col justify-between overflow-hidden relative group">
            ...
            <div className="space-y-4 z-10 max-w-md">
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Your messages belong to you. SecondMind runs on a local-first architecture. It processes texts directly in secure enclaves using AES-256 encryption. We never store, read, or sell your private conversation data.
              </p>
            </div>
                ...
                >
                  {isPlaying ? (
                    ...
                    <>
                      ...
                      <span>Analyze with SecondMind AI</span>
                    </>
                  )}
                </button>
                  ...
                  {!isPlaying && !showAiResult && (
                    <div className="flex flex-col items-center justify-center py-16 text-center space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-[11px] text-slate-600 mt-1 max-w-[200px]">Click 'Analyze with SecondMind AI' to trigger the parser.</p>
                      </div>
                    </div>
                  )}
          ...
          {[
            {
              ...
              a: "We prioritize your privacy above all. SecondMind utilizes bank-grade OAuth connections to sync your channels. All cognitive summaries and reply draft processing are performed inside secure sandboxed execution enclaves. Your data is encrypted in transit and at rest using AES-256 protocols."
            },
            {
              q: "Does the AI read all my private chats continuously?",
              a: "No. SecondMind's listener engine parses raw metadata streams to identify target tasks. It only processes message body text when specific events occur (e.g., extracting reminders, creating requested summaries, or drafting answers). You have granular control to pause syncing on any chat, channel, or email at any moment."
            },
            {
            ...
            },
            {
              ...
              a: "Yes! SecondMind features built-in high-accuracy speech-to-text translators. When you receive a long voice message, the system transcribes it locally and supplies a text digest so you can grasp the key points without listening to the audio."
            }
          ].map((faq, index) => {
        ...
        <div className="glass-premium rounded-3xl p-8 sm:p-12 md:p-16 relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto space-y-8 relative z-10">
            ...
            <p className="text-slate-400 text-sm sm:text-base max-w-lg mx-auto">
              Join 1,400+ professionals using SecondMind AI to unify their messaging, emails, and reminders. Start your 14-day free trial today.
            </p>
      ...
      <footer className="bg-slate-950 border-t border-white/5 relative z-10 pt-20 pb-8 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-6 gap-10 pb-16">
          ...
          <div className="col-span-2 space-y-6">
            <a href="#" className="flex items-center space-x-2.5">
              ...
              <span className="text-lg font-bold tracking-tight text-white">SecondMind<span className="text-purple-500">.ai</span></span>
            </a>
            <p className="text-xs text-slate-400 max-w-sm leading-relaxed">
              SecondMind AI brings clarity to your communication channels, orchestrating summaries, draft response suggests, and reminder calendar syncs.
            </p>
        ...
        <div className="max-w-7xl mx-auto pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          <span>&copy; {new Date().getFullYear()} SecondMind AI Inc. All rights reserved.</span>
